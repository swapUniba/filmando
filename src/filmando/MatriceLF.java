...
public class MatriceLF {
    ...
    public static void scriviIDFeLemmi() throws Exception{
        ...
        ObjectOutputStream oos1 = new ObjectOutputStream(new FileOutputStream(path+"filesFilmando\\" + configurazioneLemmi + "\\strutture\\insiemeLemmi.dat"));
        oos1.writeObject(insiemeLemmi);
        oos1.flush();
        oos1.close();

        ObjectOutputStream oos2 = new ObjectOutputStream(new FileOutputStream(path+"filesFilmando\\" + configurazioneLemmi + "\\strutture\\lemmiIDF.dat"));
    ...
    public static void leggiIDFeLemmi() throws Exception {
        ...
        ObjectInputStream ois1 = new ObjectInputStream(new FileInputStream(path+"filesFilmando\\" + configurazioneLemmi + "\\strutture\\insiemeLemmi.dat"));
        insiemeLemmi = (HashSet<String>) ois1.readObject();
        ois1.close();

        ObjectInputStream ois2 = new ObjectInputStream(new FileInputStream(path+"filesFilmando\\" + configurazioneLemmi + "\\strutture\\lemmiIDF.dat"));
    ...
    public static void generaLemmi() throws Exception {
        ...
        Scanner frasi = new Scanner(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\idFraseLemmi.txt"));
    ...
    public static void stampaMatriceLemmaFraseFile() throws Exception{
        ...
        PrintWriter out = new PrintWriter(new File(path+"filesFilmando\\" + configurazioneLemmi +"\\matrice lemma frase.txt"));
