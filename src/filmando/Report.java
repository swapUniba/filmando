...
public class Report {
    ...
    public HashMap<Integer, HashMap<String, Double>> sistemaVsBaselineSingoliContesti(){
        ...
        contesto6.put("centroide", totale6 != 0 ? (double)centroide6/totale6 : 0);
        contesto6.put("singole", totale6 != 0 ? (double)singole6/totale6 : 0);
        contesto6.put("sistema", totale6 != 0 ? (double)sistema6/totale6 : 0);
        contesto6.put("baseline", totale6 != 0 ? (double)baseline6/totale6 : 0);

        contesto7.put("centroide", totale7 != 0 ? (double)centroide7/totale7 : 0);
        contesto7.put("singole", totale7 != 0 ? (double)singole7/totale7 : 0);
    ...
    public HashMap<Integer, HashMap<String, Double>> sistemaVsBaselineFilm(){
        HashMap<Integer, HashMap<String, Double>> preferenzaNumeroContesti = new HashMap<Integer, HashMap<String, Double>>();
        ...
        for (int film : contatoriLocaliSuggeriti().keySet()){
            Integer totale1 = totale.get(film);

            HashMap<String, Double> contesto = new HashMap<String, Double>();

            if(centroide.containsKey(film)) {
                contesto.put("centroide", totale1 != 0 ? (double) centroide.get(film) / totale1 : 0);
            }else{
                contesto.put("centroide", 0.0);
            }
            if(singole.containsKey(film)) {
                contesto.put("singole", totale1 != 0 ? (double) singole.get(film) / totale1 : 0);
            }
            else {
                contesto.put("singole", 0.0);
            }
    ...
    public HashMap<Integer, HashMap<String, Double>> sistemaVsBaselineContesti(){
        HashMap<Integer, HashMap<String, Double>> preferenzaNumeroContesti = new HashMap<Integer, HashMap<String, Double>>();
    ...
    public Report() throws Exception {
        ...
        Scanner users = new Scanner(new File(Configurazione.path+"filesFilmando/utenti.txt"), "UTF-8");
        users.nextLine();
        ...
        Scanner val1 = new Scanner(new File(Configurazione.path+"filesFilmando/valutazione1.txt"), "UTF-8");
        val1.nextLine();
        ...
        Scanner val2 = new Scanner(new File(Configurazione.path+"filesFilmando/valutazione2.txt"), "UTF-8");
        val2.nextLine();
        ...
        Scanner val3 = new Scanner(new File(Configurazione.path+"filesFilmando/valutazione3.txt"), "UTF-8");
        val3.nextLine();
        ...
        Scanner val4 = new Scanner(new File(Configurazione.path+"filesFilmando/valutazione4.txt"), "UTF-8");
        val4.nextLine();
