...
public class MatriceContestiItemFrasi {
    ...
    public static HashMap<HashSet<Integer>, HashMap<Integer, ArrayList<Integer>>> matriceContestiItemFrasi = new HashMap<>();
    ...
    public static void inizializzaMatriceFilm() throws Exception {

        PrintWriter out = new PrintWriter(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\contesti-item-frasi 2.txt"));
                ...
                for (int c = 5; c <= 7; c++) {
                    if (c == 5) c = 0;
                            ...
                            if (!combinazioniContesti.contains(ins) && ins.size() != 0){
                                ...
                                for (int locale : Top10LocaliPerCombinazione.contestiItem.get(ins)) {
                                ...
                                matriceContestiItemFrasi.put(ins, localeFrasi);
    ...
    public static void inizializzaMatriceBari() throws Exception {
        ...
        PrintWriter out = new PrintWriter(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\contesti-item-frasi bari2.txt"));
    ...
    public static void inizializzaMatriceTorino() throws Exception {
        ...
        PrintWriter out = new PrintWriter(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\contesti-item-frasi torino2.txt"));
    ...
    public static void scriviMatriceBari() throws Exception {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream((new File(path+"filesFilmando\\"+configurazioneLemmi+"\\contesti-item-frasi bari.dat"))));
    ...
    public static void scriviMatrice() throws Exception {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream((new File(path+"filesFilmando\\"+configurazioneLemmi+"\\contesti-item-frasi.dat"))));
    ...
    public static void scriviMatriceTorino() throws Exception {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream((new File(path+"filesFilmando\\"+configurazioneLemmi+"\\contesti-item-frasi torino.dat"))));
    ...
    public static void leggiMatrice() throws Exception {
        ...
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File(path+"filesFilmando/"+configurazioneLemmi+"/contesti-item-frasi.dat")));
    ...
    public static void leggiMatriceBari() throws Exception {
        ...
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File(path+"filesFilmando/"+configurazioneLemmi+"/contesti-item-frasi bari.dat")));
    ...
    public static void leggiMatriceTorino() throws Exception {
        ...
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream(new File(path+"filesFilmando/"+configurazioneLemmi+"/contesti-item-frasi torino.dat")));
