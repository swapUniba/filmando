...
public class ServletGestioneInfoUtente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        do{
            ...
            f = new File(Configurazione.path+"filesFilmando/temp/utente"+tempo+".txt");
        ...
        Files.write(Paths.get(Configurazione.path+"filesFilmando/utenti.txt"), output.getBytes(), StandardOpenOption.APPEND);
