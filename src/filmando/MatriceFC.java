...
public class MatriceFC {
    ...
    public static void inizializzaMatriceFraseContesto() throws Exception {
        ...
        try {
            ...
            // File di lettura
            Scanner fileFrasiContesti = new Scanner(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\idFraseidContesti.txt"), "UTF-8");
    ...
    public static void stampaMatriceFraseContestoFile() throws Exception {
        ...
        PrintWriter out = new PrintWriter(new File(path+"filesFilmando\\" + configurazioneLemmi + "\\strutture\\matrice frase contesto.txt"));
